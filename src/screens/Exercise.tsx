...
import { Box, Heading, HStack, Icon, Image, ScrollView, Text, Toast, useToast, VStack } from '@gluestack-ui/themed';
  ...
  async function handleExerciseHistoryRegister() {
    try {
      ...
      toast.show({
        ...
        render: () => (
          <Toast action="error" variant="outline">
            <ToastTitle style={{marginTop: 10, backgroundColor: 'green'}}>'Parabéns! Exercício registrado com sucesso.'</ToastTitle>
          </Toast>
        ) 
      })
