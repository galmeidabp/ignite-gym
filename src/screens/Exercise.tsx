  ...
  return (
    <VStack flex={1}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{paddingBottom: 62}}>
        <VStack p='$8'>
          <Image source={{uri: 'https://img.freepik.com/vetores-premium/ilustracao-de-design-plano-de-academia-de-treino_290097-3185.jpg'}} alt='Imagem do exercício' mb='$3' resizeMode='cover' rounded='$lg' w='$full' h='$80' />
